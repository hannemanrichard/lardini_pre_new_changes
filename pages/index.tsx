        ...
        <header className="bg-white border-b fixed top-0 h-20 w-full z-20">
          <div className="w-full flex justify-between px-3 py-3">
            ...
            <div className=" mt-3">
              <a
                href="#form"
                className=" bg-emerald-600 hover:bg-emerald-500 duration-150 ease-in-out text-white px-6 py-3 rounded-lg font-bold"
              >
                أطلب الآن
              </a>
            </div>
                ...
                <form action="#" method="post">
                  ...
                  <div className="mt-4">
                    <button
                      ...
                      disabled={isLoading}
                      type="submit"
                      className="bg-emerald-600 hover:bg-emerald-500 duration-150 ease-in-out text-white button-bounce text-2xl rounded-lg w-full p-4 text-center  font-bold "
                    >
                  ...
                  <div className="w-full block md:hidden">
                    ...
                    province === "" ? (
                      <a
                        href="#form"
                        className="bg-emerald-500 text-white fixed bottom-3 left-3 right-3 text-xl rounded-lg  p-3 text-center  font-bold hover:bg-emerald-400"
                      >
                        أطلب الآن
                      </a>
                    ) : (
                      <button
                        ...
                        disabled={isLoading}
                        type="submit"
                        className="bg-emerald-500 z-20 text-white fixed bottom-3 left-3 right-3 text-xl rounded-lg  p-3 text-center  font-bold hover:bg-emerald-400"
                      >
                        {isLoading && <span className="loader"></span>}أطلب الآن
                      </button>
                    )}
